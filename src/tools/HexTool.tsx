  ...
  const handleProcess = () => {
    ...
    setTimeout(() => {
      try {
        if (mode === 'toHex') {
          // Convert text to hex
          const hexOutput = Array.from(input)
  ...
  return (
    <div>
      <div className="flex items-center mb-4">
        <Hash className="text-cyber-green-500 mr-2" size={24} />
      ...
      <div className="mb-4">
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            placeholder={mode === 'toHex' ? 'Enter text to convert to hexadecimal...' : 'Enter hexadecimal values (e.g., 48 65 6c 6c 6f)...'}
          />
        </div>
